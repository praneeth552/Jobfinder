...
export function middleware(request: NextRequest) {
  ...
  const protectedRoutes = ['/dashboard', '/preferences', '/upgrade', '/billing', '/saved', '/applied', '/fly', '/data'];
...
export const config = {
  matcher: ['/dashboard/:path*', '/preferences/:path*', '/signin', '/upgrade', '/billing', '/saved', '/applied', '/fly', '/data'],
};
