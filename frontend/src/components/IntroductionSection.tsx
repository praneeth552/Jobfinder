...
export default function IntroductionSection() {
  return (
    <section className="flex flex-col items-center justify-center py-20 px-4">
      <h3 className="text-4xl font-bold mb-4 text-gray-900 dark:text-white text-center">
        What is TackleIt?
      </h3>
      <p className="text-gray-800 dark:text-gray-300 max-w-3xl text-center text-xl">
