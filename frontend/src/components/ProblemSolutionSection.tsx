...
export default function ProblemSolutionSection() {
  return (
    <section className="py-20 px-4 bg-white dark:bg-gray-900 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl">
        <div className="flex flex-col items-center text-center">
          ...
          <h4 className="text-2xl font-semibold mb-2 text-gray-900 dark:text-white">The Problem</h4>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h4 className="text-2xl font-semibold mb-2 text-gray-900 dark:text-white">Our Solution</h4>
          <p className="text-gray-900 dark:text-gray-300">
