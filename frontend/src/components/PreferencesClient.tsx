...
// --- Data Constants ---
const ROLES = ["Software Engineer", "Frontend Developer", "Backend Developer", "Fullstack Developer", "React Developer", "Angular Developer", "Vue.js Developer", "Node.js Developer", "Python Developer", "Java Developer", "Go Developer", "Ruby on Rails Developer", "DevOps Engineer", "Site Reliability Engineer (SRE)", "Cloud Engineer", "Security Engineer", "Mobile App Developer", "React Native Developer", "Flutter Developer", "iOS Developer", "Android Developer", "Game Developer", "Embedded Systems Engineer", "Blockchain Developer", "Data Analyst", "Data Scientist", "Machine Learning Engineer", "AI Engineer", "Data Engineer", "Product Manager", "Engineering Manager", "Technical Lead", "Solutions Architect", "UI/UX Designer", "QA Engineer", "Database Administrator (DBA)"];
const LOCATIONS = ["Hyderabad", "Bangalore", "Delhi NCR", "Pune", "Chennai", "Mumbai", "San Francisco Bay Area", "New York City", "London", "Berlin", "Singapore", "Toronto", "Dubai", "Austin", "Seattle", "Remote (India)", "Remote (Global)"];
const EXPERIENCE_LEVELS = ["Internship", "Fresher", "1-3 Years", "3-5 Years", "5-7 Years", "7-10 Years", "10+ Years", "Lead / Principal"];
const SALARY_RANGES = ["0-5 LPA", "5-10 LPA", "10-20 LPA", "20-30 LPA", "30-50 LPA", "50-75 LPA", "75+ LPA"];
const COMPANY_SIZES = ["Seed / Early-Stage (1-10)", "Startup (11-50)", "Mid-Size (51-500)", "Large (501-5000)", "Enterprise (5000+)", "Unicorn / Scale-up", "FAANG / Big Tech"];
const JOB_TYPES = ["Full-time", "Part-time", "Contract", "Internship", "Freelance / Consultant"];
const WORK_ARRANGEMENTS = ["On-site", "Hybrid", "Remote"];
const UNIQUE_TECH_SKILLS = ["JavaScript", "TypeScript", "Python", "Java", "C#", "Go", "Rust", "PHP", "Ruby", "Swift", "Kotlin", "C++", "Elixir", "ReactJS", "Next.js", "Angular", "Vue.js", "Svelte", "HTML5", "CSS3", "SASS/SCSS", "TailwindCSS", "Bootstrap", "Redux", "Zustand", "GraphQL", "Apollo Client", "Webpack", "Vite", "Node.js", "ExpressJS", "Django", "Flask", "FastAPI", "Spring Boot", ".NET", "Ruby on Rails", "Laravel", "Phoenix", "MongoDB", "MySQL", "PostgreSQL", "SQLite", "Redis", "DynamoDB", "Cassandra", "Firebase", "Supabase", "Prisma", "SQLAlchemy", "React Native", "Flutter", "SwiftUI", "Jetpack Compose", "PyTorch", "TensorFlow", "Scikit-learn", "Pandas", "NumPy", "Jupyter", "LangChain", "LLMs", "NLP", "Spark", "Kafka", "Hadoop", "Docker", "Kubernetes", "AWS", "Azure", "GCP", "Vercel", "Heroku", "Terraform", "Ansible", "Jenkins", "GitHub Actions", "CI/CD", "Git", "REST API", "gRPC", "WebSockets", "Cybersecurity", "Three.js", "WebRTC", "Solidity"];
