...
const UpgradePage = () => {
  ...
  const handleUpgrade = async () => {
    ...
    try {
      ...
      const options = {
        ...
        handler: async function () {
          try {
            ...
            // Redirect will happen when modal is closed
          } catch (err: unknown) {
      ...
      rzp.open();
      // Set loading to false here because Razorpay takes over
      setIsLoading(false);
      ...
      setError(errorMessage); // Show inline error for initiation failure
      setIsLoading(false);
    }
    // We don't use finally here because of Razorpay's async nature
  };
    ...
    <>
      <NotificationModal
        ...
        onClose={() => {
          ...
          // Redirect to dashboard only on successful upgrade
          if (notificationDetails.type === "success") {
