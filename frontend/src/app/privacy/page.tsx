...
const PrivacyPolicy = () => {
  const sections = [
    ...
    },
    {
      ...
      bullets: [
        { label: "What We Access:", text: "When you enable the Google Sheets integration, our application requests access to the Google Drive API (drive.file scope). The drive.file scope is limited exclusively to files that Tackleit has created — we cannot access, read, modify, or delete any other files in your Google Drive." },
        ...
        { label: "No AI Training:", text: "We strictly DO NOT use any data obtained from Google Workspace APIs to develop, improve, or train generalized Artificial Intelligence (AI) or Machine Learning (ML) models." },
        ...
        { label: "Revoking Access:", text: "You can disable the Google Sheets integration at any time from your Tackleit dashboard. When you disable it, our application programmatically revokes the OAuth token via Google's revocation endpoint and immediately deletes the stored credentials from your user profile." },
        { label: "No Transfer to Third Parties:", text: "We do not transfer or share Google user data to third parties, except when necessary to provide or improve user-facing features that are prominent in the requesting application's user interface, to comply with applicable laws, or as part of a merger, acquisition, or sale of assets. We never sell your Google data." },
        { label: "Limited Use Compliance:", text: "Tackleit's use and transfer to any other app of information received from Google APIs will adhere to the Google API Services User Data Policy, including the Limited Use requirements." }
      ]
    },
    {
