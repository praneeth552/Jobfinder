    ...
    <div className="bg-gray-50 text-gray-800 min-h-screen dark:bg-gray-900 dark:text-gray-100">
      ...
      <main className="pt-20">
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="py-12 bg-white shadow-lg rounded-lg my-12 dark:bg-gray-800">
            <div className="text-center max-w-4xl mx-auto px-6">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 dark:text-white">How It Works</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">Sign up and tell us about yourself. Fill out your detailed preferences, including your desired roles, tech stack, experience level, and location.</p>
                </div>
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2 dark:text-white">AI-Powered Matching</h3>
                  <p className="text-gray-600 dark:text-gray-300">Our intelligent algorithms get to work, scanning thousands of job listings to find the ones that align perfectly with your profile.</p>
                </div>
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2 dark:text-white">Receive Personalized Jobs</h3>
                  <p className="text-gray-600 dark:text-gray-300">Get a curated list of job recommendations delivered directly to your dashboard, saving you hours of manual searching.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="py-12">
            <div className="text-center max-w-4xl mx-auto px-6">
              <h2 className="text-3xl font-bold text-gray-900 mb-8 dark:text-white">Our Features & Plans</h2>
              <p className="text-lg text-gray-600 mb-8 dark:text-gray-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                <div className="border border-gray-200 rounded-lg p-6 dark:border-gray-700">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4 dark:text-white">Free Plan</h3>
                ...
                <div className="border-2 border-blue-600 rounded-lg p-6 relative">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4 dark:text-white">Pro Plan</h3>
                  <ul className="space-y-3">
