      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="bg-white shadow-lg rounded-lg p-8 md:p-12">
            <h1 className="text-4xl font-extrabold text-gray-900 text-center mb-6">Terms and Conditions</h1>
            ...
            <div className="space-y-8 text-lg text-gray-700">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-800 mb-4">4. Subscriptions and Payments</h2>
                <p className="mb-3">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-800 mb-4">5. Use of the Service</h2>
                <p>
